      ...
      <DialogContent className="sm:max-w-md">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-2 mt-2">
          ...
          <Button 
            ...
            className="self-stretch sm:self-auto btn-hover-effect hover-scale transition-transform"
          >
            {copied ? (
              <span className="flex items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-check hover-pulse"><path d="M20 6 9 17l-5-5"/></svg>
                Copied
              </span>
            ) : (
              <span className="flex items-center gap-1">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-copy hover-pulse"><rect width="14" height="14" x="8" y="8" rx="2" ry="2"/><path d="M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2"/></svg>
                Copy
              </span>
            )}
          </Button>
        ...
        <div className="mt-6">
          ...
          <div className="flex justify-center sm:justify-start gap-4">
            <button 
              ...
              className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-500 text-white hover:bg-blue-600 transition-colors shadow-sm hover-pulse hover-scale transition-transform"
            ...
            <button 
              ...
              className="flex items-center justify-center w-12 h-12 rounded-full bg-blue-700 text-white hover:bg-blue-800 transition-colors shadow-sm hover-pulse hover-scale transition-transform"
            ...
            <button 
              ...
              className="flex items-center justify-center w-12 h-12 rounded-full bg-red-500 text-white hover:bg-red-600 transition-colors shadow-sm hover-pulse hover-scale transition-transform"
        ...
        <DialogFooter className="mt-6 sm:mt-4 flex justify-center sm:justify-end">
          <Button 
            ...
            className="w-full sm:w-auto hover-scale transition-transform"
          >
            Close
          </Button>
        </DialogFooter>
